...
import ru.iesorokin.ordermanager.orchestrator.core.constants.process.ATOL_REFUND_DOCUMENT_NUMBER
import ru.iesorokin.ordermanager.orchestrator.core.constants.process.ATOL_REFUND_ID
import ru.iesorokin.ordermanager.orchestrator.core.constants.process.ATOL_REFUND_REGISTRATION_NUMBER
import ru.iesorokin.ordermanager.orchestrator.core.constants.process.ATOL_REFUND_STORAGE_NUMBER
import ru.iesorokin.ordermanager.orchestrator.core.constants.process.ATOL_REFUND_UUID
import ru.iesorokin.ordermanager.orchestrator.core.constants.process.PAYMENT_TASK_ID
import ru.iesorokin.ordermanager.orchestrator.core.domain.PaymentTaskFiscalData
import ru.iesorokin.ordermanager.orchestrator.core.exception.EmptyFieldException
import ru.iesorokin.ordermanager.orchestrator.core.service.PaymentTaskService
import ru.iesorokin.ordermanager.orchestrator.core.task.longVariable
